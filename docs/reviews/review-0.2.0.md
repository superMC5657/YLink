...
- ~~**tests/e2e/zz-errfail.spec.ts:1-22** — [P3] Committed debug spec with zero assertions and 5s sleeps pollutes CI runs (its `8080` tracing targets a non-mock backend); `mobile.spec.ts:27` ends with an unasserted `isVisible()`.~~
