...
const PATHS: Record<string, string> = {
  ...
  traffic: '<path d="M3 3v18h18"/><path d="m19 9-5 5-4-4-3 3"/>',
  // 仪表板
  wallet:
  ...
  qr: '<rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/><rect x="3" y="14" width="7" height="7" rx="1"/><path d="M14 14h3v3h-3zM21 14v.01M14 21v.01M17 21h4v-4"/>',
