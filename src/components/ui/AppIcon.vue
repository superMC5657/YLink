...
/**
 * 轻量线性图标组件(24×24 stroke 风格,Lucide 图标路径,ISC 许可)。
 * 离线可用、随 currentColor 变色;替代在线 Iconify 图标,保证演示环境稳定。
 */
...
const PATHS: Record<string, string> = {
  ...
  gift:
    '<rect x="3" y="8" width="18" height="4"/><path d="M12 8v13"/><path d="M19 12v7a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2v-7"/><path d="M7.5 8a2.5 2.5 0 0 1 0-5C11 3 12 8 12 8s1-5 4.5-5a2.5 2.5 0 0 1 0 5"/>',
  agent:
  ...
  ticket:
    '<path d="M2 9a3 3 0 0 0 0 6v2a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-2a3 3 0 0 1 0-6V7a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2z"/><path d="M13 5v2M13 11v2M13 17v2"/>',
  traffic:
  ...
  qr:
    '<rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/><rect x="3" y="14" width="7" height="7" rx="1"/><path d="M14 14h3v3h-3zM21 14v.01M14 21v.01M17 21h4v-4"/>',
  credit:
...
<template>
  <svg
    ...
    aria-hidden="true"
    v-html="PATHS[props.name] ?? PATHS.info"
  />
</template>
